#!/usr/bin/python
#
# This program outputs the following information about the conformers of a residue:
# 1. H bond partners
# 2. Torsion angles
# 3. RMSD to conformers of the same residue
# 
# At least one residue id is re	quired as input
#
import sys, math
...
#....................................................................................
if len(sys.argv) < 2:
   print "SYNTAX: resconfs.py IDstring1 [IDstring2 ...]"
   print "Description: This program computes geometry differences of conformers within a residue in step3_out.pdb."
